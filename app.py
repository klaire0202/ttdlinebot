...
def handle_message(event):
    ...
    responses = {
        ("dc","chatgpt","facebook","touch","gamerch",".com","2930","cd","npc","cpu","cp","ic","打手出界","擋出界","call"): None,
