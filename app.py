...
def handle_message(event):
    ...
    cleaned_message = re.sub(r'[\U00010000-\U0010ffff]', '', user_message)  # Remove Emojis
    ...
    # If message consists only of emojis, ignore the message
    if not cleaned_message.strip() or cleaned_message == user_message:
        return
